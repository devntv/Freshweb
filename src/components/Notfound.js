  ...
  return (
    <div className='footer-container'>
      <section className='footer-subscription'>
        <p className='footer-subscription-heading' style={{color:'#f90046', fontSize:'50px'}}>
                404- PAGES IS NOT FOUND :'(
        </p>
        <p className='footer-subscription-text'style={{color:'#ffd62f'}}>
          Please fresh this page and press into home to load the website.
        </p>
